"""Utility routines. Logging setup, directory/file traversal. 
TODO there should be an option in bin/run_analysis to set level of logger
with default being INFO 
